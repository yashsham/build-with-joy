...
const IMAGE_VERSION = "hermosa-luxe-v7";
...
const SERVICES_IMAGES_MALE: Record<string, string> = {
  // Male Grooming
  "mens-haircut-styling": "/assets/service-mens-haircut-styling.png",
  "mens-beard-trim-shave": "/assets/service-mens-beard-trim-shave.png",
  "mens-dtan-cleanup": "/assets/service-mens-dtan-cleanup.png",
  ...
  // Unisex Spa & Massage (Male versions)
  "aroma-therapy-body-massage": "/assets/service-aroma-therapy-body-massage-male.png",
  "deep-tissue-stress-relief": "/assets/service-deep-tissue-stress-relief-male.png",
  "swedish-back-shoulder-massage": "/assets/service-swedish-back-shoulder-massage-male.png",
  "pain-relief-ayurvedic-massage": "/assets/service-pain-relief-ayurvedic-massage-male.png",
  "head-neck-shoulder-massage": "/assets/service-mens-head-shoulder-massage.png",
  "foot-reflexology": "/assets/service-foot-reflexology-male.png",
  "multisession-spa-package": "/assets/ad-multisession-male.png",

  // Unisex Hair Care (Male versions)
  "keratin-therapy": "/assets/service-keratin-therapy-male.png",
  "hair-smoothening": "/assets/service-hair-smoothening-male.png",
  "global-hair-coloring": "/assets/service-global-hair-coloring-male.png",
  "antihairfall-spa-combo": "/assets/service-antihairfall-spa-combo-male.png",

  // Unisex HydraGlo (Male versions)
  "classic-hydraglo": "/assets/service-classic-hydraglo-male.png",
  "superbright-hydraglo": "/assets/service-superbright-hydraglo-male.png",
  "agedefying-hydraglo": "/assets/service-agedefying-hydraglo-male.png",
  "mini-hydraglo": "/assets/service-mini-hydraglo-male.png",

  // Unisex Laser (Male versions)
  "underarms-laser-hair-reduction": "/assets/service-underarms-laser-hair-reduction-male.png",
  "full-face-laser-glow": "/assets/service-full-face-laser-glow-male.png",
  "full-body-laser-reduction-3": "/assets/service-full-body-laser-reduction-3-male.png",
  "arms-legs-laser-reduction": "/assets/service-arms-legs-laser-reduction-male.png"
};
...
export class HermosaImageRegistry {
  ...
  static resolveServiceImage(
    ...
    if (activeGender === "male") {
      if (SERVICES_IMAGES_MALE[slug]) {
        return this.appendVersion(SERVICES_IMAGES_MALE[slug]);
      }
      // Fallback to SERVICES_IMAGES if male mapping not defined
    ...
    if (activeGender === "male") {
      if (searchString.includes("laser")) {
        return this.appendVersion("/assets/service-underarms-laser-hair-reduction-male.png");
      }
      if (searchString.includes("hydraglo")) {
        return this.appendVersion("/assets/service-classic-hydraglo-male.png");
      }
      if (searchString.includes("massage") || searchString.includes("spa") || searchString.includes("relax")) {
        if (searchString.includes("head") || searchString.includes("shoulder")) {
